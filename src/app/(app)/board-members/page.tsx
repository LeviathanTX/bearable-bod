...
import { boardMembers, boardMemberTemplates } from '@/lib/db/schema';
import { eq } from 'drizzle-orm';
import { BoardStudio } from '@/components/BoardStudio';
...
export default async function BoardMembersPage() {
  ...
  const [members, templates] = await Promise.all([
    ...
    db.select().from(boardMemberTemplates),
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <BoardStudio initialMembers={members} templates={templates} />
    </div>
  );
}
